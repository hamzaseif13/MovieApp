  ...
  return (
    <main className={`max-w-main m-auto  px-10 bg-[url('assets/bg.jpeg')] bg-cover bg-center text-white   h-[22rem]  flex flex-col py-20 justify-around`}>
      <div className=''>
        ...
        <p className='text-4xl'>Millions of movies, TV shows and people to discover. Explore now.</p>
      </div>
      <div className='relative  my-4'>
        <form action="" onSubmit={e=>e.preventDefault}>
          <input type="text" className='rounded-full focus:outline-none z-10 text-black border-dark py-3 pl-4  w-full'
